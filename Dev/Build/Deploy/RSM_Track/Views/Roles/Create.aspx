...
<% using (Html.BeginForm()) { %>
    ...
    <tbody>
        <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td align="right"><input type="submit" value="Save" /> <%: Html.ActionLink("Back to Role List", "Index") %></td>
        </tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            setupLevelGrid("#alist", "Available", '../../Roles/AvailableLevels/?ID=<%=ViewBag.Role.RoleID%>', assignByDoubleClick);
