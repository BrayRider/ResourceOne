...
namespace RSM.Service.Library.Tests.Controllers
{
    ...
    public class Settings
    {
        ...
        public void Search()
        {
            ...
            var testSetting = Factory.CreateSetting(settingName, "Test Setting Label", "value", 0, true, InputTypes.Text, system);
            var testSetting2 = Factory.CreateSetting(settingName + " 2", "Test Setting Label 2", "value", 0, true, InputTypes.Text, system2);
            var testSetting3 = Factory.CreateSetting(settingName + " 2", "Test Setting Label 2", "value", 0, true, InputTypes.Text, system);
