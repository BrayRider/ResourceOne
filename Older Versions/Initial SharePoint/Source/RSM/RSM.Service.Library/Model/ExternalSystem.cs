...
namespace RSM.Service.Library.Model
{
	public class ExternalSystem : Entity
	{
		...
		public static ExternalSystem LubrizolIn = Factory.CreateExternalSystem(6, "Lubrizol", ExternalSystemDirection.Incoming);
		public static ExternalSystem LubrizolOut = Factory.CreateExternalSystem(7, "Lubrizol", ExternalSystemDirection.Outgoing);
		#endregion
	}
}
