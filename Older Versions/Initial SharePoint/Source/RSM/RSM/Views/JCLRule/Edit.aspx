...
<% using (Html.BeginForm()) { %>
    ...
    <input type="hidden" name="gridData" id="gridData" value="" />
     ...
     <div id="ruletop">
                    ...
                    <tr>
                        ...
                        <td>
                            <%: Html.DropDownListFor(model => model.DeptID,
                                                 new SelectList(ViewBag.Depts, "DeptID", "DeptDescr", ViewBag.Model.DeptID.ToString()))%>
                        </td>
                        <td>Facility:</td>
                        <td>
                            <%: Html.DropDownListFor(model => model.Location,
                                                 new SelectList(ViewBag.Locs, "LocationID", "LocationName", ViewBag.Model.Location))%>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <p align=right><input type="submit" value="Save" />&nbsp;&nbsp;<%: Html.ActionLink("Copy This Rule", "Clone", new { Id = Model.ID })%>&nbsp;&nbsp;<%: Html.ActionLink("Back to Rules", "Index") %></p>
    </div>
...
<asp:Content ID="Content5" ContentPlaceHolderID="BreadCrumbs" runat="server">
    <a href="<%=Url.Action("Index", "Admin") %>">Admin</a> - <a href="../">Rules</a> - Edit
</asp:Content>
