...
namespace RSM.Staging.Library.Models
{
	public class StagingTools
	{
		...
		[Display(Name = "Lubrizol Incoming")]
		public bool LubrizolIncoming { get; set; }

		[Display(Name = "Lubrizol Outgoing")]
		public bool LubrizolOutgoing { get; set; }
		...
		public bool Lubrizol
		{
			get { return LubrizolIncoming || LubrizolOutgoing; }
		}
