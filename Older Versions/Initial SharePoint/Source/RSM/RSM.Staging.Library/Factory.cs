...
namespace RSM.Staging.Library
{
	...
	public class Factory
	{
		...
		#region Employee
		public static LzEmployee CreateEmployee(
			string company,
			string country, 
			string department,
			string division,
			string departmentName,
			string employeeClassDesc,
			string employeeId,
			char employeeStatus,
			...
			string supervisorId,
			string supervisorInitials,
			string supervisorName
			)
		{
			var entity = new LzEmployee
			{
				Company = company,
				Country = country, 
				...
				EmployeeClassDesc = employeeClassDesc,
				...
				ReportingLocationName = reportingLocationName,
		...
		public LzEmployee createEmployee(
			string company,
			string country, 
			string department,
			string division,
		...
		{
			var entity = Factory.CreateEmployee(company, country, department, division, departmentName, employeeClassDesc, employeeId, employeeStatus, employeeStatusDesc,
			                                    firstName, initials, jobDescr, lastLoadDate, lastName, legalEntity, middleName, name, physicalLocation, physicalLocationName, reportingLocation, reportingLocationName,
			                                    supervisorId, supervisorInitials, supervisorName);
